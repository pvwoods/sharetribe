...
(function(module) {
  ...
  module.initializeShippingPriceTotal = function(locale, currency, quantityInputSelector, shippingPriceSelector){
    ...
    var updateShippingPrice = function() {
      $shippingPriceElements.each(function(index, shippingPriceElement) {
        ...
        var priceForDisplay = Intl.NumberFormat(locale, {style: "currency", currency: currency}).format(newShippingPrice);
        console.log(priceForDisplay);

...
function updateSellerGetsValue(locale, currency, priceInputSelector, displayTargetSelector, currencySelector, communityCommissionPercentage, minCommission, showReversed) {
  ...
  function updateYouWillGet() {
    ...
    $display.text(
      Intl.NumberFormat(locale, {style: "currency", currency: currency}).format(displaySum)
    );
  }

  ...
  def shipping_info(shipping_type, shipping_price, shipping_price_additional)
    if shipping_type == :shipping && shipping_price_additional.present?
      I18n.translate("listings.show.shipping_price_additional",
                     price: MoneyViewUtils.to_humanized(shipping_price, I18n.locale),
                     shipping_price_additional: MoneyViewUtils.to_humanized(shipping_price_additional, I18n.locale))
    elsif shipping_type == :shipping
      I18n.translate("listings.show.shipping", price: MoneyViewUtils.to_humanized(shipping_price, I18n.locale))
    elsif shipping_type == :pickup
      I18n.translate("listings.show.pickup", price: MoneyViewUtils.to_humanized(shipping_price, I18n.locale))
    else

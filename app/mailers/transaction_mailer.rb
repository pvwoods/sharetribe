      ...
      premailer_mail(:to => seller_model.confirmed_notification_emails_to,
        ...
        format.html {
          render "paypal_payment_receipt_to_seller", locals: {
                   ...
                   listing_price: MoneyViewUtils.to_humanized(transaction[:listing_price], seller_model.locale),
                   listing_quantity: transaction[:listing_quantity],
                   duration: transaction[:booking].present? ? transaction[:booking][:duration] : nil,
                   subtotal: MoneyViewUtils.to_humanized(transaction[:item_total], seller_model.locale),
                   payment_total: MoneyViewUtils.to_humanized(payment_total, seller_model.locale),
                   shipping_total: MoneyViewUtils.to_humanized(transaction[:shipping_price], seller_model.locale),
                   payment_service_fee: MoneyViewUtils.to_humanized(-service_fee, seller_model.locale),
                   paypal_gateway_fee: MoneyViewUtils.to_humanized(-gateway_fee, seller_model.locale),
                   payment_seller_gets: MoneyViewUtils.to_humanized(you_get, seller_model.locale),
      ...
      premailer_mail(:to => buyer_model.confirmed_notification_emails_to,
        ...
        format.html {
          render "payment_receipt_to_buyer", locals: {
                   ...
                   quantity_selector_label: quantity_selector_label,
                   listing_price: MoneyViewUtils.to_humanized(transaction[:listing_price], buyer_model.locale),
                   listing_quantity: transaction[:listing_quantity],
                   duration: transaction[:booking].present? ? transaction[:booking][:duration] : nil,
                   subtotal: MoneyViewUtils.to_humanized(transaction[:item_total], buyer_model.locale),
                   shipping_total: MoneyViewUtils.to_humanized(transaction[:shipping_price], buyer_model.locale),
                   payment_total: MoneyViewUtils.to_humanized(transaction[:payment_total], buyer_model.locale),
